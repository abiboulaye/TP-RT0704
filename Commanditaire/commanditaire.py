...
connection = pika.BlockingConnection(pika.ConnectionParameters(host="192.168.56.102"))
channel = connection.channel()

def create_file(file):
    r = requests.post("http://192.168.56.102:5000/rabbit/create/"+file)
    print(r.text)

def write(msg,file):
    param = {"data" : msg}
    r = requests.post("http://192.168.56.102:5000/rabbit/"+file, data=param)
    print(r.text)
...
if __name__ == "__main__":
    ...
    tache = {}
    tache["git"] = "https://github.com/abiboulaye.N_dames.git"
    tache["tache_id"] = "5"
    tache["soustache_id"] = "1"
    tache["cmd"] = "python3 N_dames.py 6 5 1"
